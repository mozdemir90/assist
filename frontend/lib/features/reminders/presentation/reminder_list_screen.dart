          ...
          if (reminders.isEmpty) {
            return Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.alarm_add, size: 64, color: AppColors.textSecondaryLight.withOpacity(0.5)),
                  const SizedBox(height: 16),
                  Text('Henüz hatırlatıcı yok.', style: Theme.of(context).textTheme.titleMedium),
                ],
              ),
            );
          }
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                    backgroundColor: isPast ? AppColors.textSecondaryLight : AppColors.primaryBlue.withOpacity(0.1),
                    child: Icon(Icons.alarm, color: isPast ? Colors.white : AppColors.primaryBlue),
                  ),
                  ...
                  subtitle: Text(
                    ...
                    style: TextStyle(color: isPast ? AppColors.errorRed : AppColors.textSecondaryLight),
                  ),
                  trailing: IconButton(
      ...
      builder: (ctx) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Yeni Hatırlatıcı", style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 24),
              TextField(
                controller: titleController,
                decoration: const InputDecoration(labelText: 'Ne hatırlatalım?'),
                autofocus: true,
              ),
              const SizedBox(height: 24),
              ElevatedButton.icon(
                ...
                onPressed: () {
                  if (titleController.text.isNotEmpty) {
                    ...
                    ref.read(reminderListProvider.notifier).addReminder(
                          ...
                          trigger.isBefore(now) ? trigger.add(const Duration(days: 1)) : trigger,
                        );
                    Navigator.pop(ctx);
                  }
                },
